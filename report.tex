...
%
Il videogioco “C.F.U.” si pone come obiettivo il raggiungimento dell’ambita laurea mancante del player; suddetta laurea sarà ottenibile mediante l’esplorazione del campus di Cesena nel quale si è rimasti intrappolati. Muovendosi all’interno del campus saranno reperibili oggetti che permetteranno interazioni con l’ambiente (ad es. chiavi per aprire porte).\\Per raggiungere la laurea non sarà necessario risolvere tutti gli enigmi, quella di risolverli tutti rimarrà una scelta personale.\\Gli enigmi saranno di tipo mentale (delle domande a cui dare risposta), saranno indipendenti dal resto dell’ambiente e terranno fede al corso di laurea di “ingegneria e scienze informatiche” (classe L-8 ingegneria dell’informazione e L-31 scienze e tecnologie informatiche).\\Nel momento in cui il player uscirà dall’ultima stanza gli verrà fornita la laurea col voto di conseguimento, tale voto dipenderà da quanti enigmi sono stati risolti.
%
...
\begin{itemize}
    ...
    \item le entità devono essere graficamente diverse, a seconda anche del loro stato, utilizzando colori e forme diverse;
\end{itemize}
...
La View si occupa esclusivamente dei meccanismi di cattura dell’input e visualizzazione dell’output. La view non dovrà dipendere né dal controller né dal model: Il gioco, in fase di debug, dovrà poter essere eseguito anche in un’interfaccia a caratteri.
